...
import site.liangbai.lbapi.hologram.nms.packet.*
...
class NMSImpl : NMS() {
    ...
    override fun sendEntityPacket(player: Player, vararg packets: PacketEntity) {
        packets.forEach {
            ...
            when (it) {
                ...
                is PacketItemModify -> {
                    var entity = 0
                    val itemNull = it.itemStack.isAir()
            ...
            version >= 11600 -> {
                sendPacket(
                    ...
                    PacketPlayOutEntityEquipment(
                        ...
                        listOf(
                            Pair(
                                EnumItemSlot.fromName(slot.toNMS()),
            ...
            version >= 11300 -> {
                sendPacket(
                    ...
                    net.minecraft.server.v1_13_R2.PacketPlayOutEntityEquipment(
                        entityId,
                        net.minecraft.server.v1_13_R2.EnumItemSlot.fromName(slot.toNMS()),
                ...
                sendPacket(
                    ...
                    net.minecraft.server.v1_12_R1.PacketPlayOutEntityEquipment(
                        entityId,
                        net.minecraft.server.v1_12_R1.EnumItemSlot.a(slot.toNMS()),
                        org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asNMSCopy(itemStack) as net.minecraft.server.v1_12_R1.ItemStack
                    )
                )
            }
        }
    ...
    fun EquipmentSlot.toNMS(): String {
        return when (this) {
